...
package com.shiming.shangmi.weight;
...
import com.shiming.base.utils.QMUICollapsingTextHelper;
import com.shiming.base.utils.QMUILangHelper;
import com.shiming.base.utils.QMUIViewHelper;
import com.shiming.base.widget.IWindowInsetLayout;
...
public class QMUICollapsingTopBarLayout extends FrameLayout implements IWindowInsetLayout {
    ...
    public QMUICollapsingTopBarLayout(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        mCollapsingTextHelper.setExpandedTextAppearance(R.style.CollapsingTopBarLayoutExpanded);
        mCollapsingTextHelper.setCollapsedTextAppearance(R.style.CollapsingTopBarLayoutCollapsed);
