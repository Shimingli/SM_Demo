...
import com.shiming.base.utils.QMUIDrawableHelper;
import com.shiming.base.utils.QMUILangHelper;
import com.shiming.base.utils.QMUIResHelper;
...
public class QMUITopBar extends RelativeLayout {
    ...
    void getCommonFieldFormTypedArray(Context context, TypedArray array) {
        mLeftBackDrawableRes = array.getResourceId(R.styleable.QMUITopBar_qmui_topbar_left_back_drawable_id, R.mipmap.ic_nav_back);
    ...
    public void setTitleViewColor(@ColorInt int color){
